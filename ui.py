...
class SimulationUI:
    ...
    def _create_widgets(self):
        ...
        self.angle_label = ctk.CTkLabel(self.angle_frame, text="Угол наклона (град):", width=150, anchor="w", 
                                        text_color=self._get_theme_color("fg"))
        ...
        self.air_resistance_slider = ctk.CTkSlider(self.air_resistance_frame, from_=0, to=10, 
